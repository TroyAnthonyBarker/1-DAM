...
Suponiendo que cada mes tiene un número distinto de días (febrero siempre 28).
*/
...
public class Ejercicio10 {
	 public static void main(String[] args){
		 ...
		 int diferencia = 1, mes = 0, ano = 365, diafecha1 = 0, diafecha2 = 0, mesfecha1 = 0, mesfecha2 = 0, anofecha1 = 0, anofecha2 = 0, difsDias = 0, difsMeses = 0, difsAnos = 0;
